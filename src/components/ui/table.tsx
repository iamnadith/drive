...
function Table({
  ...
  return (
    <div
      ...
      className={cn(
        "relative w-full max-w-full overflow-x-auto rounded-2xl [-ms-overflow-style:none] [scrollbar-width:thin]",
        containerClassName
      )}
    >
      <table
...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      ...
      className={cn(
        "max-w-[28rem] p-3 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
        className
      )}
      {...props}
    />
