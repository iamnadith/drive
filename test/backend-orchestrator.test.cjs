...
test("worker sync is aggregate-only and resumable across CPU-limited invocations", () => {
  ...
  assert.match(orchestrator, /const WORKER_BUILD = 21/)
  ...
  assert.match(orchestrator, /bucketOffset: nextSettingsOffset, reconciled: true/)
  assert.match(orchestrator, /bucketOffset: nextOffset, reconciled: true/)
