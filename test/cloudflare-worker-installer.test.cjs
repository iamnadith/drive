...
test("installer is resumable, locked and keeps secrets on release redeploy", () => {
  ...
  assert.match(installer, /process\.env\.POSTGRES_URL \|\| process\.env\.POSTGRES_PRISMA_URL \|\| process\.env\.POSTGRES_URL_NON_POOLING/)
