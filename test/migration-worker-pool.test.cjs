...
test('GitHub pool workers rotate before the six-hour limit and release unfinished work durably', () => {
  ...
  assert.match(workflow, /MAX_RUNTIME_SECONDS: \$\{\{ github\.event\.client_payload\.max_runtime_seconds \|\| '21000' \}\}/)
  assert.match(orchestrator, /GITHUB_WORKER_MAX_RUNTIME_SECONDS = 21_000/)
  ...
  assert.match(orchestrator, /if \(!heartbeatStale\) continue/)
